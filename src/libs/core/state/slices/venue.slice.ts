...
import {
  ...
  VenueStats,
  VenueWithServices,
} from '@/libs/services/api/types/venue.types';
import { venueApiService } from '@/libs/services/api/VenueApiService';
...
export const fetchVenuesAsync = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const result = await venueApiService.getVenues(apiFilters, pagination);
      return {
...
export const updateVenueAsync = createAsyncThunk(
  ...
  async (venueData: UpdateVenueData, { rejectWithValue }) => {
    try {
      ...
      const result = await venueApiService.updateVenue(id, updateData);
      return result;
    } catch (error: any) {
      return rejectWithValue({
...
export const fetchNearbyVenuesAsync = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const result = await venueApiService.searchVenuesByLocation(latitude, longitude, radius);
      return result;
    } catch (error: any) {
      return rejectWithValue({
