...
import { User, UserRoleEnum as UserRole } from '@prisma/client';
import { USER_CONSTANTS } from '@constants/database.constants';
...
class UserManagementUseCase {
  ...
  async getUserStats(): Promise<{
    ...
    const [total, active, adminCount, managerCount, employeeCount, userCount, superAdminCount] =
      await Promise.all([
    ...
    return {
      ...
      byRole: {
        ...
        [UserRole.SUPER_ADMIN]: superAdminCount,
      },
